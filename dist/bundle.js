...
const o$6 = (t) => new s$3('string' == typeof t ? t : t + '', void 0, e$7),
	r$3 = (t, ...n) => {
		const o =
			1 === t.length
				? t[0]
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ var s$2;
const e$6 = window.trustedTypes,
	r$2 = e$6 ? e$6.emptyScript : '',
...
class a$1 extends HTMLElement {
	...
	requestUpdate(t, i, s) {
		let e = !0;
		void 0 !== t &&
			(((s = s || this.constructor.getPropertyOptions(t)).hasChanged || n$4)(
				this[t],
				i
			)
...
(a$1.finalized = !0),
	...
	null == h$3 || h$3({ReactiveElement: a$1}),
...
const i$1 = globalThis.trustedTypes,
	...
	d$1 = Array.isArray,
	u = (t) =>
		d$1(t) || 'function' == typeof (null == t ? void 0 : t[Symbol.iterator]),
	c = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
	v = /-->/g,
	a = />/g,
	f = RegExp(
		...
		for (let i = 0; i < o; i++) {
			...
			r +=
				d === c
					? s + n$3
					: p >= 0
					? (l.push(o), s.slice(0, p) + '$lit$' + s.slice(p) + e$5 + y)
					: s + e$5 + (-2 === p ? (l.push(void 0), i) : y);
		}
			...
			if (1 === l.nodeType) {
				if (l.hasAttributes()) {
					...
					for (const i of l.getAttributeNames())
						if (i.endsWith('$lit$') || i.startsWith(e$5)) {
							const s = a[d++];
							if ((t.push(i), void 0 !== s)) {
								const t = l.getAttribute(s.toLowerCase() + '$lit$').split(e$5),
									i = /([.?@])?(.*)/.exec(s);
								c.push({
									type: 1,
									index: r,
				...
				if (m.test(l.tagName)) {
					const t = l.textContent.split(e$5),
						s = t.length - 1;
					if (s > 0) {
				...
				if (l.data === o$4) c.push({type: 2, index: r});
				else {
					let t = -1;
					for (; -1 !== (t = l.data.indexOf(e$5, t + 1)); )
						c.push({type: 7, index: r}), (t += e$5.length - 1);
				}
			r++;
		}
	}
...
class N {
	...
	S(t) {
		...
		for (const o of t)
			e === i.length
				? i.push((s = new N(this.j(h$2()), this.j(h$2()), this, this.options)))
				: (s = i[e]),
				s._$AI(o),
				e++;
...
class s extends a$1 {
	...
	update(t) {
		...
		this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
			super.update(t),
			(this._$Do = T(i, this.renderRoot, this.renderOptions));
	}
	connectedCallback() {
		var t;
 ...
 */ const e$1 = (i, t) => {
		...
		for (const i of n)
			null === (o = (s = i)._$AO) || void 0 === o || o.call(s, t, !1),
				e$1(i, t);
		return !0;
	},
	o$1 = (i) => {
...
function h$1(i, t = !1, s = 0) {
	...
	if (void 0 !== r && 0 !== r.size)
		if (t)
			if (Array.isArray(n))
				for (let i = s; i < n.length; i++) e$1(n[i], !1), o$1(n[i]);
  ...
  `;
	...
	render() {
		...
		const results = this.clickedRun
			? this.results || $`<loader-element></loader-element>`
			: testTxt;
		return $`
			<div class="row mt-3">
				<div class="col-sm-12">
			...
			<div class="row mt-4">
				<div class="col-sm-12">
					<div class="card">
						<div class="card-body">
							<div ${n(this.starterRef)} class="sortable-code starter"></div>
							<div ${n(this.solutionRef)} class="sortable-code solution"></div>
				...
				<div class="col-sm-12">
					<div class="card">
						...
						<div id="test_description">
							<div class="card-body">${o$2(results)}</div>
						</div>
					</div>
...
function handleSubmit(submittedCode, reprCode, codeHeader) {
	...
	if (!(codeLines[0].includes('def') || codeLines[0].includes('class'))) {
		probEl.setAttribute(
			'results',
			'First code line must be `def` or `class` declaration'
		);
		return;
	}
	...
	try {
		...
		if (error.message.startsWith('Traceback')) {
			...
			let testResults =
				'<div class="testcase fail"><span class="msg">Syntax error</span></div>';
			testResults +=
				'<span style="white-space: pre-line"><pre><code>' +
				errorMsg +
				'  <pre></code></span></div>';
